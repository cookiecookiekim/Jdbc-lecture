...
public class JDBCTemplate { // 24-09-30 (월) 3교시 - chap01 복 붙
    ...
    public static void close (Statement stmt) { // close 메서드를 따로 만들어 준다.
        // & 비트 연산자 : 좌항과 우항 모두 비교 (좌항이 false더라도 우항을 비교해줌)
        try {
    ...
    public static void close (ResultSet rset) { // close 메서드를 따로 만들어 준다.
        // & 비트 연산자 : 좌항과 우항 모두 비교 (좌항이 false더라도 우항을 비교해줌)
        try {
